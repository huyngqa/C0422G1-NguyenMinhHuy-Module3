        ...
        <ul class="form-section page-section">
          ...
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            *
            ...
            <span class="form-radio-item" style="clear:left">
              ...
              <input type="radio" aria-describedby="label_313" class="form-radio validate[required]" id="input_313_0"
                     name="gender" checked value="true" required=""/>
            ...
            *
                    ...
                    <div id="cid_313_false" class="form-input jf-required">
                        <div class="form-single-column" role="group" aria-labelledby="label_313" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_313" class="form-radio validate[required]" id="input_313_0_false"
                     name="gender" value="true" required=""/>
              <label id="label_input_313_0_false" for="input_313_0_false"> Nam </label>
            </span>
                            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_313" class="form-radio validate[required]" id="input_313_1_false"
                     name="gender" checked value="false" required=""/>
              <label id="label_input_313_1_false" for="input_313_1_false"> Nữ </label>
            </span>
                        </div>
                    </div>
                </li>
