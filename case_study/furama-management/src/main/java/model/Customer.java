...
public class Customer extends Person {
    ...
    public Customer(String name, LocalDate dateOfBirth, String identityCardNumber, String tel, String email, String address, TypeCustomer typeCustomerName, boolean gender) {
        super(name, dateOfBirth, identityCardNumber, tel, email, address);
        this.typeCustomerName = typeCustomerName;
        this.gender = gender;
    }
