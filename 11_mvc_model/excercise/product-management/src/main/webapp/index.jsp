    ...
    <c:forEach var="product" items="${products}" varStatus="status">
        <tr>
            ...
            <td>
                ...
                <div class="modal fade" id="exampleModal-${product.productId}" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Bạn có chắc chắn muốn xoá sản phẩm: ${product.productName}
                            </div>
                            <div class="modal-footer">
                                <button type="reset" class="btn btn-secondary" data-bs-dismiss="modal">Không
                                </button>
                                <a href="/products?action=delete&id=${product.productId}" class="btn btn-primary">
                                    Có
                                </a>
                            </div>
                        </div>
