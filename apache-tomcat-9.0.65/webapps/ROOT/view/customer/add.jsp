        ...
        <ul class="form-section page-section">
            <li id="cid_293" class="form-input-wide" data-type="control_head">
                <div class="form-header-group header-default"
                     style="background-image: url('../../resources/img/employee.jpg')">
                    <div class="header-text httal htvam">
                        <h2 id="header_293" class="form-header" data-component="header">
                            Employment Application
                        </h2>
                        <div id="subHeader_293" class="form-subHeader">
                            Fill the form below accurately indicating your potentials and suitability to job applying
                            for.
                        </div>
                    </div>
                </div>
          ...
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <li class="form-line" data-type="control_number" id="id_312">
                <label class="form-label form-label-left form-label-auto" id="label_312" for="input_312">
                    Salary </label>
                <div id="cid_312" class="form-input">
                    <input type="number" id="input_312" name="q312_salary" data-type="input-number"
                           class=" form-number-input form-textbox" data-defaultvalue="" style="width:60px" size="5"
                           value="" placeholder="ex: 23" data-component="number" aria-labelledby="label_312"
                           step="any"/>
                </div>
            </li>
          ...
          <span class="form-sub-label-container" style="vertical-align:top">
              ...
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_4_addr_line2" name="q4_address4[addr_line2]"
                         class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_4 off"
                         value="" data-component="address_line_2" aria-labelledby="label_4 sublabel_4_addr_line2"/>
                  <label class="form-sub-label" for="input_4_addr_line2" id="sublabel_4_addr_line2"
                        ...
                        <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-city-line jsTest-address-lineField form-address-hiddenLine"
                    style="display:none">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_4_city" name="q4_address4[city]" class="form-textbox form-address-city"
                         data-defaultvalue="" autoComplete="section-input_4 address-level2" value=""
                         data-component="city" aria-labelledby="label_4 sublabel_4_city"/>
                  <label class="form-sub-label" for="input_4_city" id="sublabel_4_city" style="min-height:13px"
                         aria-hidden="false"> City </label>
                </span>
              </span>
                            <span class="form-address-line form-address-state-line jsTest-address-lineField form-address-hiddenLine"
                                  style="display:none">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_4_state" name="q4_address4[state]"
                         class="form-textbox form-address-state" data-defaultvalue=""
                         autoComplete="section-input_4 address-level1" value="" data-component="state"
                  ...
                  <label class="form-sub-label" for="input_4_state" id="sublabel_4_state" style="min-height:13px"
                        ...
                        <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-zip-line jsTest-address-lineField form-address-hiddenLine"
                    style="display:none">
                <span class="form-sub-label-container" style="vertical-align:top">
            ...
            *
            ...
            <span class="form-radio-item" style="clear:left">
              ...
              <input type="radio" aria-describedby="label_316" class="form-radio validate[required]" id="input_316_0"
                     name="q316_division" value="Type option 1" required=""/>
              <label id="label_input_316_0" for="input_316_0"> Villa </label>
            </span>
                        <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_316" class="form-radio validate[required]" id="input_316_1"
                     name="q316_division" value="Type option 2" required=""/>
              <label id="label_input_316_1" for="input_316_1"> House </label>
            </span>
                        <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_316" class="form-radio validate[required]" id="input_316_2"
                     name="q316_division" value="Type option 3" required=""/>
            ...
            <li class="form-line" data-type="control_email" id="id_323">
                <label class="form-label form-label-left form-label-auto" id="label_323" for="input_323">
                    Username </label>
                <div id="cid_323" class="form-input">
                    <input type="email" id="input_323" name="q323_username" class="form-textbox validate[Email]"
                           data-defaultvalue="" size="30" value="" data-component="email" aria-labelledby="label_323"/>
                </div>
            </li>
